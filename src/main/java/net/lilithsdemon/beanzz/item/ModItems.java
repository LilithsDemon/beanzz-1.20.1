...
public class ModItems {
    ...
    public static final RegistryObject<Item> bean = ITEMS.register("bean", () -> new ItemNameBlockItem(ModBlocks.bean_crop.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> bean_seed = ITEMS.register("bean_seeds", () -> new BlockItem(ModBlocks.bean_crop.get(), new Item.Properties()));
